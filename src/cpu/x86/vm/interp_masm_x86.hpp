...
class InterpreterMacroAssembler: public MacroAssembler {
 ...
 public:
  ...
  void profile_ret(Register return_bci, Register mdp, Register tmp);
 ...
 public:
  void bound_check_profile(Register tmp0, Label& cont);
  void profile_obj_type(Register obj, const Address& mdo_addr);
  void profile_arguments_type(Register mdp, Register callee, Register tmp, Register tmp2, bool is_virtual);
