...
Mutex*   MethodDataSerialization_lock = NULL;
...
void mutex_init() {
  ...
  def(MethodData_lock              , PaddedMutex  , nonleaf+4,   false, Monitor::_safepoint_check_always);
  def(MethodDataSerialization_lock , PaddedMutex  , nonleaf+4,   false, Monitor::_safepoint_check_always);
