...
extern uint32_t CurrentIteration;
...
#undef TLAB_FIELD_OFFSET
 ...
 public:
  ...
  void timing(double *user, double *sys);
  void print_and_update_timing();
...
class CompilerThread : public JavaThread {
 ...
 private:
  ...
  CompilerThread *_next_ct;
  volatile bool _pause_comp;
  Monitor *_pause_comp_monitor;
  static CompilerThread *_first_ct;
...
class Threads: AllStatic {
 ...
 public:
  static pmap<pstring, uint> *_compilable_methods;
  static uint max_method_priority;
  static void parse_compilable_methods_list();
  static uint compilable_methods_contains_priority(Method *m);
};
