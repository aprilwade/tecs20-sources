...
#define VM_OPS_DO(template)                       \
  ...
  template(PrintThreadTiming)                     \
  template(LoadProfilingData)                     \
...
class VM_PrintThreadTiming : public VM_Operation {
 public:
  VM_PrintThreadTiming() { }

  VMOp_Type type() const { return VMOp_PrintThreadTiming; }
  //VMOp_Type type() const { return VMOp_PrintThreads; }
  virtual void doit();
};
