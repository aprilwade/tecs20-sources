...
//  first_hrtime = gethrtime();
  ...
  init_random(initial_time_count);
  ...
  tty->print_raw_cr("uname:");
  tty->print_cr("    sysname:  %s", uname_data.sysname);
  tty->print_cr("    nodename: %s", uname_data.nodename);
  tty->print_cr("    release:  %s", uname_data.release);
  tty->print_cr("    version:  %s", uname_data.version);
  tty->print_cr("    machine:  %s", uname_data.machine);
